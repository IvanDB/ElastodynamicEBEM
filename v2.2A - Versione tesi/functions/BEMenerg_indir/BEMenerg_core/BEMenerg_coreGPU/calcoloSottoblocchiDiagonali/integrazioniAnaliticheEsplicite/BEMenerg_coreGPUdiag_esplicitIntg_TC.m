function [ris1, ris2, ris3, ris4] = BEMenerg_coreGPUdiag_esplicitIntg_TC(rhoS, THETA1, THETA2, infoTri2D, B)
% INPUT
% - 
% - 
% OUTPUT
...
G = BEMenerg_coreGPUdiag_coeffG_TC(rhoS, THETA1, THETA2, infoTri2D);
