...
clc
close all
clearvars -except indForm indProblem indMethodCore indMethodPP basePath betaVal
...
listMethods = ["SA 03", "SA 07", "SA 12", "SA 19", ...
               ...
               "FN 37 64 3 256", "FN 60 64 3 256", ...
               "FN 12 256 1 256", "FN 19 256 1 256", "FN 37 256 1 256", "FN 60 256 1 256", ...
              ];
    ...
    case "DD"
        switch methodInfo.typeIntg
            case "FN"
                ...
                density = BEMenerg_dir_timeMarchingD_uConstSpace(pbParam, domainMesh, methodInfo, EXTn, EXTw, INTn, INTw, DIAGn, DIAGw);
            otherwise
                error("Metodo non disponibile per la formulazione selezionata")
        end
        %Plot della densità ottenuta
    ...
    case "DN"
        switch methodInfo.typeIntg
            case "FN"
                ...
                density = BEMenerg_dir_timeMarchingN_uConstSpace(pbParam, domainMesh, methodInfo, EXTn, EXTw, INTn, INTw, DIAGn, DIAGw);              
            otherwise
                error("Metodo non disponibile per la formulazione selezionata")
        end
        %Plot della densità ottenuta
