...
for beta = [1, 2, 4]
    ...
    for indProblem = 1 : length(listProblems)
        ...
        g = detDir(pbParam);
        % path = "./outputData/HPC - test beta = " + beta + "/" + pbParam.domainType + pbParam.lev + "_NEW_37_256_1_256_density.mat";
        path = "./outputData/HPC - test beta = " + beta + "/" + pbParam.domainType + pbParam.lev + "_NEW_19_64_3_256_density.mat";
        if ~exist(path, "file")
        ...
        parfor indTemp = 1 : pbParam.nT
            ...
            for indT = 1 : domainMesh.numberTriangles
                ...
                appVal = density(3*(indT-1) + (1:3), indTemp);
                f = @(x, t) (g(x, t) -  appVal) .^ 2;
