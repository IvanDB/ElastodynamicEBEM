function ris = BEMenerg_dir_calcSubBlockDiagV(pbParam, methodInfo, indTemp, deltaT, constValuesBlock, DIAGn, DIAGw)
...
for var = 1 : 3
    ...
    for indGH = 1 : nGH
        ...
        baseFunctionsValues = constValuesBlock.matCoeff * nodoExt' + constValuesBlock.vetCoeff;
        ...
        for indChild = 1 : 3
            ...
            for indG2DC = 1 : methodInfo.numNodiDiag
                ...
                intgG2DC = intgG2DC + G2DCweights(indG2DC) .* kron(baseFunctionsValues, nu(vettX, lungX, currT));
            end
        end
