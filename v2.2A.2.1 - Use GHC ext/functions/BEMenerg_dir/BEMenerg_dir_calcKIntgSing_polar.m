function intgTotSing = BEMenerg_dir_calcKIntgSing_polar(methodInfo, pbParam, diffTemp, vettVMS, indVsmCurr, constValuesS, constValuesF, normInt, DIAGn, DIAGw, minDiffTemp)
...
for indNodoExt = 1 : numNodiExt
    ...
    for indChild = 1 : 3
        [nodi3D, pesi3D] = generatePolarG2Dnodes(constValuesF.DIAGverts{indNodoExt, indChild}, cS * minDiffTemp, cP * diffTemp, sqrt(numNodiDiag), sqrt(numNodiDiag));
