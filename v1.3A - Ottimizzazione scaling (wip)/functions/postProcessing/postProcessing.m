function u = postProcessing(pb_param, domainMesh, density, x, t)
% INPUT
% - 
% - 
% OUTPUT
...
if t > 0
    ...
    matrix_tcurr = postProcessing_calcMatrix(pb_param, domainMesh, matrix_tcurr, x, DeltaT_next);
    ...
    for ind_temp = 0 : n_hat-1
            ...
            matrix_tnext = postProcessing_calcMatrix(pb_param, domainMesh, matrix_tnext, x, DeltaT_next);
