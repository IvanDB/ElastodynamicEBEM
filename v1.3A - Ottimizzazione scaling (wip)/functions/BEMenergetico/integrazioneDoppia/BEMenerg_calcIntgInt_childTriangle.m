function [ris1, ris2, ris3, ris4, ris5, ris6] = BEMenerg_calcIntgInt_childTriangle(tri2D, infoTri2D, zeta, R_P, rho_P, R_S, rho_S, sign_prod, type_intg)
%INPUT
% - 
%
%OUTPUT
...
matB = BEMenerg_coeffB(zeta, infoTri2D, sign_prod);
...
if (THETA1 < THETA2)
    ...
    if(type_intg == "SP_SP")
        [ris5t, ris6t] = BEMenerg_esplicitIntg_SC_SP(R_S, rho_S, zeta, THETA1, THETA2, infoTri2D, matB);
    end
    
    %Calcolo integrali su CORONA CIRCOLARE (regione E6)
    if(type_intg == "P")
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_SC_P(R_P, rho_P, zeta, THETA1, THETA2, infoTri2D, matB);
    else
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_CC(R_S, rho_S, R_P, rho_P, zeta, THETA1, THETA2, infoTri2D, matB);
    end
...
if (THETA2 < THETA3)
    ...
    if(type_intg == "SP_SP")
        [ris5t, ris6t] = BEMenerg_esplicitIntg_SC_SP(R_S, rho_S, zeta, THETA2, THETA3, infoTri2D, matB);
    end

    %Calcolo integrali su TRIANGOLO CIRCOLARE (regione E7)
    if(type_intg == "P")
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_TR_P(zeta, THETA2, THETA5, infoTri2D, matB);
    else
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_TC(zeta, R_S, rho_S, THETA2, THETA3, infoTri2D, matB);
    end
    %Aggiornamento valore integrali globali
    ris1 = ris1 + ris1t;
    ris2 = ris2 + ris2t;
...
if (THETA3 < THETA4)
    ...
    if(type_intg == "SP_SP")
        [ris5t, ris6t] = BEMenerg_esplicitIntg_TR_SP(zeta, THETA3, THETA4, infoTri2D, matB);
    end
    %Aggiornamento valore integrali globali
    if(type_intg == "SP_SP")
        ris5 = ris5 + ris5t;
...
if (THETA4 < THETA5)
    ...
    if(type_intg == "SP_SP")
        [ris5t, ris6t] = BEMenerg_esplicitIntg_SC_SP(R_S, rho_S, zeta, THETA4, THETA5, infoTri2D, matB);
    end

    %Calcolo integrali sul SECONDO TRIANGOLO CIRCOLARE (regione E8)
    [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_TC(zeta, R_S, rho_S, THETA4, THETA5, infoTri2D, matB);
...
if (THETA5 < THETA6)
    ...
    if(type_intg == "SP_SP")
        [ris5t, ris6t] = BEMenerg_esplicitIntg_SC_SP(R_S, rho_S, zeta, THETA5, THETA6, infoTri2D, matB);
    end

    %Calcolo integrali su CORONA CIRCOLARE (regione E9)
    if(type_intg == "P")
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_SC_P(R_P, rho_P, zeta, THETA5, THETA6, infoTri2D, matB);
    else
        [ris1t, ris2t, ris3t, ris4t] = BEMenerg_esplicitIntg_CC(R_S, rho_S, R_P, rho_P, zeta, THETA5, THETA6, infoTri2D, matB);
    end
