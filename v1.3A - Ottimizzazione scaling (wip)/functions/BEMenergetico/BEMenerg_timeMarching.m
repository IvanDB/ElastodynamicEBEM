...
%% CALCOLO INTERO TERMINE NOTO

tn = zeros(3*domainMesh.number_triangles, pb_param.Nt - 1);
parfor indTemp = 1 : pb_param.Nt
    tn(:, indTemp) = BEMenerg_calcTnBlock_seq(rhs, indTemp - 1, dt, pb_param, domainMesh, gha, ghw);
end
