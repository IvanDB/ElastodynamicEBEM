function [ris1, ris2, ris3, ris4] = BEMenerg_analiticIntg_TC(zeta, RS, rhoS, THETA1, THETA2, infoTri2D, B)
% INPUT
% - 
% - 
% OUTPUT
...
if (zeta > 1.0e-6)
    ...
    G = BEMenerg_analiticIntg_coeffG_TC(zeta, RS, rhoS, THETA1, THETA2, infoTri2D);
    ...
    G = BEMenerg_analiticIntg_coeffG_TC(0, RS, rhoS, THETA1, THETA2, infoTri2D);
