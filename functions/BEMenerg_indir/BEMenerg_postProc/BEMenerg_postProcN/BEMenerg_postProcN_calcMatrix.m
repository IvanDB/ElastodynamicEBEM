function matrix = BEMenerg_postProcN_calcMatrix(pbParam, domainMesh, methodInfo, constValues, sourcePoint, deltaT)
% INPUT
% - 
% - 
% OUTPUT
...
for indT = 1 : numTriangles        
    ...
    ris = BEMenerg_postProcN_calcMatrixBlock(pbParam, methodInfo, constValues{indT}, sourcePoint, deltaT);
