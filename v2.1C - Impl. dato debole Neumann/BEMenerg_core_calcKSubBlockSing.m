function KSubBlock = BEMenerg_core_calcKSubBlockSing(methodInfo, deltaT, pbParam, domainMesh, DIAGn, DIAGw, indTemp, indM, constValuesCurr, indVsmCurr)
...
for indZeta = 1 : 4
    ...
    intgTot = BEMenerg_core_calcKIntgSing(methodInfo, pbParam, diffTemp, vettVMS, indVsmCurr, constValuesCurr, constValuesCurr, normInt, DIAGn, DIAGw);
