function [ris1, ris2, ris3, ris4, ris5, ris6] = BEMenerg_coreGPUdiag_calcIntgInt_childTriangle(tri2D, infoTri2D, rhoP, rhoS)
%INPUT
% - 
%
%OUTPUT
...
matB = BEMenerg_coreGPUdiag_coeffB(infoTri2D);
...
if (THETA1 < THETA2)
    ...
    [ris5t, ris6t] = BEMenerg_coreGPUdiag_esplicitIntg_SC(rhoS, THETA1, THETA2, infoTri2D, matB);
    %Calcolo integrali su CORONA CIRCOLARE (regione E6)
    [ris1t, ris2t, ris3t, ris4t] = BEMenerg_coreGPUdiag_esplicitIntg_CC(rhoS, rhoP, THETA1, THETA2, infoTri2D, matB);
...
if (THETA2 < THETA3)
    ...
    [ris5t, ris6t] = BEMenerg_coreGPUdiag_esplicitIntg_SC(rhoS, THETA2, THETA3, infoTri2D, matB);

    %Calcolo integrali su TRIANGOLO CIRCOLARE (regione E7)
    [ris1t, ris2t, ris3t, ris4t] = BEMenerg_coreGPUdiag_esplicitIntg_TC(rhoS, THETA2, THETA3, infoTri2D, matB);
...
if (THETA3 < THETA4)
    ...
    [ris5t, ris6t] = BEMenerg_coreGPUdiag_esplicitIntg_TR(THETA3, THETA4, infoTri2D, matB);
    %Aggiornamento valore integrali globali
    ris5 = ris5 + ris5t;
    ris6 = ris6 + ris6t;
end
...
if (THETA4 < THETA5)
    ...
    [ris5t, ris6t] = BEMenerg_coreGPUdiag_esplicitIntg_SC(rhoS, THETA4, THETA5, infoTri2D, matB);

    %Calcolo integrali sul SECONDO TRIANGOLO CIRCOLARE (regione E8)
    [ris1t, ris2t, ris3t, ris4t] = BEMenerg_coreGPUdiag_esplicitIntg_TC(rhoS, THETA4, THETA5, infoTri2D, matB);
...
if (THETA5 < THETA6)
    ...
    [ris5t, ris6t] = BEMenerg_coreGPUdiag_esplicitIntg_SC(rhoS, THETA5, THETA6, infoTri2D, matB);

    %Calcolo integrali su CORONA CIRCOLARE (regione E9)
    [ris1t, ris2t, ris3t, ris4t] = BEMenerg_coreGPUdiag_esplicitIntg_CC(rhoS, rhoP, THETA5, THETA6, infoTri2D, matB);
