function KSubBlock = BEMenerg_dirN_calcSubBlockSingK(methodInfo, deltaT, pbParam, domainMesh, DIAGn, DIAGw, indTemp, indM, constValuesCurr, indVsmCurr)
...
for indZeta = 1 : 4
    ...
    intgTot = BEMenerg_dirN_calcKIntgSing(methodInfo, pbParam, diffTemp, vettVMS, indVsmCurr, constValuesCurr, constValuesCurr, normInt, DIAGn, DIAGw);
