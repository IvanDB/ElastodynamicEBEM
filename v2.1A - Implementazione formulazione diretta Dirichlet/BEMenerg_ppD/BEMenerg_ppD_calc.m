function uXT = BEMenerg_ppD_calc(pbParam, domainMesh, density, gK, methodInfo, x, t, PPn, PPw)
% INPUT
% - 
% - 
% OUTPUT
...
constValues = BEMenerg_ppD_calcCostantData(domainMesh);
...
kernelG = parallel.gpu.CUDAKernel("kernelG.ptx", "kernelG.cu");
