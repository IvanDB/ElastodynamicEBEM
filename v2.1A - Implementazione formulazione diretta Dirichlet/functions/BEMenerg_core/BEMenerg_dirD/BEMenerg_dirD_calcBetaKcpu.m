function betaK = BEMenerg_dirD_calcBetaKcpu(methodInfo, deltaT, pbParam, domainMesh, constValues, DIAGn, DIAGw)
...
%%
    ...
    for indTemp = 1 : pbParam.nT
        K{indTemp} = BEMenerg_dirD_calcKBlock(methodInfo, indTemp - 1, deltaT, pbParam, domainMesh, constValues, DIAGn, DIAGw);
