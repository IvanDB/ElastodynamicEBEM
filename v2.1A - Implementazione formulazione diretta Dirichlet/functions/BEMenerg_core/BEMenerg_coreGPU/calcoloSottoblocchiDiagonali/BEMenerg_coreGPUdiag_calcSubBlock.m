function ris = BEMenerg_coreGPUdiag_calcSubBlock(pbParam, methodInfo, vertsT, vn, indTemp, deltaT, constValues)
%INPUT
% - 
% -
%
...
for var = 1 : 3
    ...
    for indGH = 1 : nGH    
        ...
        [rist_1, rist_2, rist_3, rist_4, rist_5, rist_6] = BEMenerg_coreGPUdiag_calcIntgInt_fieldTriangle(rP, rS, children);
