function [matrix, isnotzero] = BEMenerg_calcMatrixBlock_mod(matrix, hk, dt, pb_param, domainMesh, ghw, constValues)
%INPUT
...
parfor ind = 1 : N_triangles^2
    ...
    if(((hk-1)*pb_param.velS*dt < distmax) && ((hk+1)*pb_param.velP*dt >= distmin))
        ...
        ris = BEMenerg_calcMatrixSubBlock_mod(pb_param, areaS, TF, vnF, hk, dt, ghw, constValues{indF}.SdR, constValues{indS}.GHnodes);
