function [ris1, ris2, ris3, ris4, ris5, ris6] = BEMenerg_coreSA_calcIntgInt_fieldTriangle(zeta, RP, rhoP, RS, rhoS, children, c, sign_prod, typeIntg)
...
for indChild = 1 : 3
    ...
    [ris1t, ris2t, ris3t, ris4t, ris5t, ris6t] = BEMenerg_coreSA_calcIntgInt_childTriangle(tri2D, infoTri2D, zeta, RP, rhoP, RS, rhoS, sign_prod, typeIntg);
