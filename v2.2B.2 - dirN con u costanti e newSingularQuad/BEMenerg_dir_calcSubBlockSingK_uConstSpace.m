...
for indZeta = 1 : 4
    ...
    intgTot = BEMenerg_dir_calcKIntgSing_uConstSpace(methodInfo, pbParam, diffTemp, constValuesCurr, constValuesCurr, normInt, DIAGn, DIAGw, domainMesh.coordinates(domainMesh.triangles(indM, 1:3), :), minDiffTemp);
