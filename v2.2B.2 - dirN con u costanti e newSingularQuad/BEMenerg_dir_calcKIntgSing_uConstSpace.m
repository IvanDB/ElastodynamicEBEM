function intgTotSing = BEMenerg_dir_calcKIntgSing_uConstSpace(methodInfo, pbParam, diffTemp, constValuesS, constValuesF, normInt, DIAGn, DIAGw, vertsInt, minDiffTemp)
...
for indNodoExt = 1 : numNodiExt
    ...
    for indChild = 1 : 3
        ...
        for indDiag = 1 : length(pesiInt)                            
            ...
            nodoInt = nodiInt(indDiag, :); %DIAGn(indDiag, :) * constValuesF.DIAGverts{indNodoExt, indChild};
            pesoInt = pesiInt(indDiag); %DIAGw(indDiag) * constValuesF.DIAGarea{indNodoExt, indChild};
