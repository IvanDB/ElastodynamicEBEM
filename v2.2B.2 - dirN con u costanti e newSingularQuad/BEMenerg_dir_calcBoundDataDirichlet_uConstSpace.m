function dirBoundData = BEMenerg_dir_calcBoundDataDirichlet_uConstSpace(deltaT, pbParam, domainMesh)
%BEMENERG_CORE_CALCBOUNDDIRICHLET Summary of this function goes here
%   Detailed explanation goes here

switch pbParam.domainType
    case {"barH1-symm", "barH3"}
...
for indTemp = 1 : pbParam.nT
    gKcurr = cell(domainMesh.numberTriangles, 1);
    parfor indT = 1 : domainMesh.numberTriangles
        gKcurr{indT} = g(domainMesh.center(indT, :), indTemp*deltaT);
    end
