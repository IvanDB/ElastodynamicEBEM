...
for ind = 1 : numT * numT
    ...
    for indZeta = 1 : 4
        ...
        if indM == indMtilde
            intgTotSing = BEMenerg_dir_calcKIntgSing_uConstSpace(methodInfo, pbParam, diffTemp, constValuesS, constValuesF, normInt, DIAGn, DIAGw, domainMesh.coordinates(domainMesh.triangles(indM, 1:3), :), minDiffTemp);
        end
