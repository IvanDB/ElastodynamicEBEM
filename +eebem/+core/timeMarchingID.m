...
%Save paths
tmpPath = fullfile(basePath, "tempData", "ID_" + domainMesh.name + domainMesh.lev + "_" + quadData.methodSpecs.stringID);
outPath = fullfile(basePath, "outputData", "ID_" + domainMesh.name + domainMesh.lev + "_" + quadData.methodSpecs.stringID);
