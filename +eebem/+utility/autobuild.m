...
%   AUTOBUILD(BASEPATH, FLAG) always adds BASEPATH/buildDir to the path
%   (where the compiled artifacts, and any previously built ones, live).
...
%   All compiled artifacts are written to BASEPATH/buildDir.
%
%   Input arguments:
