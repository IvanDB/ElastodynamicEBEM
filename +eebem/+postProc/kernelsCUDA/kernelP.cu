                       ...
                       const double cP, const double cS, const double lambda, const double mu)
{
    ...
    const double cS3 = cS2*cS;

    nu[0][0] = ((lambda * x[0] * n[0] / r2) + (2 * mu * x[0] * x[0] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[0] * n[0] / r2) + (((1 / r2) - (2 * x[0] * x[0] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[0] * n[0] / r3) - (2 * mu * x[0] * n[0] / r3) - (2 * mu * ((1 / r3) - (6 * x[0] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[0] * n[0] / r3) + (3 * x[0] * n[0] / r3) + (3 * ((1 / r3) - (4 * x[0] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[0] * n[0] / r5) + (x[0] * n[0] / r5) + (((1 / r5) - (5 * x[0] * x[0] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[0][1] = ((lambda * x[0] * n[1] / r2) + (2 * mu * x[1] * x[0] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[1] * n[0] / r2) + (- ((2 * x[1] * x[0] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[0] * n[1] / r3) - (2 * mu * x[1] * n[0] / r3) - (2 * mu * (- (6 * x[1] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[0] * n[1] / r3) + (3 * x[1] * n[0] / r3) + (3 * (- (4 * x[1] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[0] * n[1] / r5) + (x[1] * n[0] / r5) + ((- (5 * x[1] * x[0] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[0][2] = ((lambda * x[0] * n[2] / r2) + (2 * mu * x[2] * x[0] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[2] * n[0] / r2) + (- ((2 * x[2] * x[0] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[0] * n[2] / r3) - (2 * mu * x[2] * n[0] / r3) - (2 * mu * (- (6 * x[2] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[0] * n[2] / r3) + (3 * x[2] * n[0] / r3) + (3 * (- (4 * x[2] * x[0] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[0] * n[2] / r5) + (x[2] * n[0] / r5) + ((- (5 * x[2] * x[0] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[1][0] = ((lambda * x[1] * n[0] / r2) + (2 * mu * x[0] * x[1] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[0] * n[1] / r2) + (- ((2 * x[0] * x[1] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[1] * n[0] / r3) - (2 * mu * x[0] * n[1] / r3) - (2 * mu * (- (6 * x[0] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[1] * n[0] / r3) + (3 * x[0] * n[1] / r3) + (3 * (- (4 * x[0] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[1] * n[0] / r5) + (x[0] * n[1] / r5) + ((- (5 * x[0] * x[1] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[1][1] = ((lambda * x[1] * n[1] / r2) + (2 * mu * x[1] * x[1] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[1] * n[1] / r2) + (((1 / r2) - (2 * x[1] * x[1] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[1] * n[1] / r3) - (2 * mu * x[1] * n[1] / r3) - (2 * mu * ((1 / r3) - (6 * x[1] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[1] * n[1] / r3) + (3 * x[1] * n[1] / r3) + (3 * ((1 / r3) - (4 * x[1] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[1] * n[1] / r5) + (x[1] * n[1] / r5) + (((1 / r5) - (5 * x[1] * x[1] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[1][2] = ((lambda * x[1] * n[2] / r2) + (2 * mu * x[2] * x[1] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[2] * n[1] / r2) + (- ((2 * x[2] * x[1] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[1] * n[2] / r3) - (2 * mu * x[2] * n[1] / r3) - (2 * mu * (- (6 * x[2] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[1] * n[2] / r3) + (3 * x[2] * n[1] / r3) + (3 * (- (4 * x[2] * x[1] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[1] * n[2] / r5) + (x[2] * n[1] / r5) + ((- (5 * x[2] * x[1] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[2][0] = ((lambda * x[2] * n[0] / r2) + (2 * mu * x[0] * x[2] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[0] * n[2] / r2) + (- ((2 * x[0] * x[2] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[2] * n[0] / r3) - (2 * mu * x[0] * n[2] / r3) - (2 * mu * (- (6 * x[0] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[2] * n[0] / r3) + (3 * x[0] * n[2] / r3) + (3 * (- (4 * x[0] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[2] * n[0] / r5) + (x[0] * n[2] / r5) + ((- (5 * x[0] * x[2] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[2][1] = ((lambda * x[2] * n[1] / r2) + (2 * mu * x[1] * x[2] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[1] * n[2] / r2) + (- ((2 * x[1] * x[2] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[2] * n[1] / r3) - (2 * mu * x[1] * n[2] / r3) - (2 * mu * (- (6 * x[1] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[2] * n[1] / r3) + (3 * x[1] * n[2] / r3) + (3 * (- (4 * x[1] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[2] * n[1] / r5) + (x[1] * n[2] / r5) + ((- (5 * x[1] * x[2] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));

    nu[2][2] = ((lambda * x[2] * n[2] / r2) + (2 * mu * x[2] * x[2] / r4 * dotProd3D(x, n))) * (((t - (r/cP)) > 0) / cP3)
                    + mu * ((x[2] * n[2] / r2) + (((1 / r2) - (2 * x[2] * x[2] / r4)) * dotProd3D(x, n))) * (((t - (r/cS)) > 0) / cS3)
                    + (((lambda - 2 * mu) * x[2] * n[2] / r3) - (2 * mu * x[2] * n[2] / r3) - (2 * mu * ((1 / r3) - (6 * x[2] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cP)) * ((t - (r/cP)) > 0) / cP2)
                    + mu * ((2 * x[2] * n[2] / r3) + (3 * x[2] * n[2] / r3) + (3 * ((1 / r3) - (4 * x[2] * x[2] / r5)) * dotProd3D(x, n))) * ((t - (r/cS)) * ((t - (r/cS)) > 0) / cS2)
                    - 6 * mu * ((x[2] * n[2] / r5) + (x[2] * n[2] / r5) + (((1 / r5) - (5 * x[2] * x[2] / r7)) * dotProd3D(x, n))) 
                                                * (((t - (r/cP)) * (t - (r/cP)) * (t + (2*r/cP)) / 6 * ((t - (r/cP)) > 0) - (t - (r/cS)) * (t - (r/cS)) * (t + (2*r/cS)) / 6 * ((t - (r/cS)) > 0)));
