function solution = loopIN(basePath, pbParam, domainMesh, density, numPoints, xVal, tVal, methodInfo, PPn, PPw)
...
parfor ind = 1 : numPoints
    ...
    solRaw{ind} = calcMatrixP(pbParam, domainMesh, density, methodInfo, xVal(indX, :), tVal(indT), PPn, PPw);
end
...
save(outPath + "_solutionPP", 'solution');
