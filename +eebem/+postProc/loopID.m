function solution = loopID(basePath, pbParam, domainMesh, density, numPoints, xVal, tVal, methodInfo, PPn, PPw)
...
parfor ind = 1 : numPoints
    ...
    solRaw{ind} = calcMatrixG(pbParam, domainMesh, density, methodInfo, xVal(indX, :), tVal(indT), PPn, PPw);
end
