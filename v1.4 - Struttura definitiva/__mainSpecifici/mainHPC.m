...
% - "MX.G2D xx yy":     integrazione esterna mediante GH a xx nodi e integrazione interna mediante DG1D a yy nodi 
...
% - "GPU    xx yy z":   esecuzione su GPU - implementato solo metodo GHC 
...
methodSelected = convertStringsToChars(listMethods(18));

[methodInfo, EXTn, EXTw, INTn, INTw] = BEmenerg_setupCore(methodSelected);
...
% - "GPU   yy z":   esecuzione su GPU - implementato solo metodo GHC 
...
postSelected = convertStringsToChars(listPost(7));
