...
problemFileName = listProblems(7);
...
[methodInfo, EXTn, EXTw, INTn, INTw] = BEmenerg_setupCore('MX.GHC 12 16 3');
...
[methodInfo, PPn, PPw] = BEmenerg_setupPost(methodInfo, 'N.GHC 16 3');
