function [ris1,ris2,ris3,ris4] = time3D_intLE_S_P_2(zeta,R_P,pR_P,R_S,pR_S,children,c,sign_prod)

%La function time3D_intLE_S_P_2() prende in INPUT:
...
%-----------------------------------------------------------------------        
        ...
        %        RUOTATO in presenza delle ONDE S e P in cui però solo le
        %        ONDE P danno contibuto
           
        [ris1t,ris2t,ris3t,ris4t] = ...
            integr_vertexLE_S_P_2(tri2D,InfoTri2D,zeta,R_P,pR_P,R_S,pR_S,sign_prod);
