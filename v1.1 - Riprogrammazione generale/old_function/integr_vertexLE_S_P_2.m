function [ris1,ris2,ris3,ris4] = integr_vertexLE_S_P_2(tri2D,Info_Tri2D,zeta,R_P,pR_P,R_S,pR_S,sign_prod)

%La function integr_vertexLE_S_P_2() prende in INPUT:
...
if(Delta_P<=1.0e-06) 
    ...
    %ANGOLI che individuano la CORONA CIRCOLARE
    theta1 = 0;
    theta2 = gamma;
...
%     plot(pR_P*cos(THETA2),pR_P*sin(THETA2),'b*');
%     hold on
%     plot(pR_P*cos(THETA4),pR_P*sin(THETA4),'b*');
%     hold on
%     plot(pR_P*cos(THETA5),pR_P*sin(THETA5),'b*');
...
%     plot(pR_P*cos(THETA2),pR_P*sin(THETA2),'b*');
%     hold on
%     plot(pR_P*cos(THETA3),pR_P*sin(THETA3),'b*');
%     hold on
%     plot(pR_P*cos(THETA4),pR_P*sin(THETA4),'b*');
%     hold on
%     plot(pR_P*cos(THETA5),pR_P*sin(THETA5),'b*');
%     hold on
%     plot(pR_P*cos(THETA6),pR_P*sin(THETA6),'b*');
    
    %Calcoliamo gli INTEGRALI su una CORONA CIRCOLARE (Regione E6) 
    %in presenza dell'ONDA P
    if (THETA1<THETA2)
        %Controlliamo che la CORONA CIRCOLARE sia NON DEGENERE.
        %In caso contrario, il risultato degli integrali sarà nullo
    ...
    %Calcoliamo gli INTEGRALI su un TRAPEZIO/TRIANGOLO CIRCOLARE 
    %(Regione E7) in presenza dell'ONDA P
    if (THETA2<THETA3)
        %Controlliamo che il TRAPEZIO/TRIANGOLO CIRCOLARE sia NON DEGENERE.
        %In caso contrario, il risultato degli integrali sarà nullo
    ...
    %Calcoliamo gli INTEGRALI su un TRAPEZIO/TRIANGOLO CIRCOLARE 
    %(Regione E8) in presenza dell'ONDA P
    if (THETA4<THETA5)
        %Controlliamo che il TRAPEZIO/TRIANGOLO CIRCOLARE sia NON DEGENERE.
        %In caso contrario, il risultato degli integrali sarà nullo
    ...
    %Calcoliamo gli INTEGRALI su una CORONA CIRCOLARE (Regione E9) 
    %in presenza dell'ONDA P
     if (THETA5<THETA6)
        %Controlliamo che la CORONA CIRCOLARE sia NON DEGENERE.
        %In caso contrario, il risultato degli integrali sarà nullo
