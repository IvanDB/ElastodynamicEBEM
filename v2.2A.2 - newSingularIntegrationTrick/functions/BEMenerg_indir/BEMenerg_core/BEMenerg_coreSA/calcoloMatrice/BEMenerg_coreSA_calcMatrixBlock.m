function [matrix, isnotzero] = BEMenerg_coreSA_calcMatrixBlock(matrix, methodInfo, indTemp, deltaT, pbParam, domainMesh, constValues)
%INPUT
...
parfor ind = 1 : numT^2
    ...
    if(((indTemp-1) * pbParam.velS * deltaT < distMax) && ((indTemp + 1) * pbParam.velP * deltaT >= distMin))
        ...
        matrixSubBlock = BEMenerg_coreSA_calcMatrixSubBlock(pbParam, methodInfo, TF, vnF, indTemp, deltaT, constValues{indF}.SdR, constValues{indS}.GHnodes, constValues{indS}.GHweights);
