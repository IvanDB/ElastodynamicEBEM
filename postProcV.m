...
%load density
form = "ID";
density = load(fullfile(basePath, "outputData", pbParam.domainType, "ID_" + pbParam.domainType + pbParam.lev + "FN_16-1_64-3_256_256" +"_density.mat")).density;
disp("density loaded");
...
[xVal, tVal, iVal, numPoints, ~] = postProc.postProc_loadPoints(pbParam);
...
glbIndexFigures = utility.plots.plotSolution(basePath, pbParam, campoVett, xVal, tVal, iVal, glbIndexFigures, form);
