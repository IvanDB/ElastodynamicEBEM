    ...
    case "DD"
        switch methodInfo.typePost 
            case "GPU"
                ...
                switch typePlot
                    case "u(:, t)"
                        [campoVett, campoVettG, campoVettP] = BEMenerg_ppD_setupLayer_TEST(pbParam, domainMesh, density, numPoints, xVal, tVal, methodInfo, PPn, PPw);
                    case "u(x, :)"
...
glbIndexFigures = plotSolution(pbParam, campoVettG, xVal, tVal, iVal, typePlot, glbIndexFigures);
glbIndexFigures = plotSolution(pbParam, campoVettP, xVal, tVal, iVal, typePlot, glbIndexFigures);
