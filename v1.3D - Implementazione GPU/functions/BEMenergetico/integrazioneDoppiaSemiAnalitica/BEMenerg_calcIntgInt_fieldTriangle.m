function [ris1, ris2, ris3, ris4, ris5, ris6] = BEMenerg_calcIntgInt_fieldTriangle(zeta, R_P, rho_P, R_S, rho_S, children, sign_prod, type_intg)
...
for ind_child = 1 : 3
    ...
    [ris1t, ris2t, ris3t, ris4t, ris5t, ris6t] = BEMenerg_calcIntgInt_childTriangle(tri2D, infoTri2D, 0, R_P, R_P, R_S, R_S, 0, type_intg);
