function u = postProcessing_N(pb_param, domainMesh, density, x, t, dgn, dgw)
% INPUT
% - 
% - 
% OUTPUT
...
if t > 0
    ...
    matrix_tcurr = postProcessing_calcMatrix_N(pb_param, domainMesh, matrix_tcurr, x, DeltaT_next, dgn, dgw);
    ...
    for ind_temp = 0 : n_hat-1
            ...
            matrix_tnext = postProcessing_calcMatrix_N(pb_param, domainMesh, matrix_tnext, x, DeltaT_next, dgn, dgw);
