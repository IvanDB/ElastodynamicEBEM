function [matrix, isnotzero] = BEMenerg_calcMatrixBlock_SA(matrix, hk, dt, pb_param, domainMesh, gha, ghw)
%INPUT
...
parfor ind = 1 : N_triangles^2
    ...
    if(((hk-1)*pb_param.velS*dt < distmax) && ((hk+1)*pb_param.velP*dt >= distmin))
        ...
        ris = BEMenerg_calcMatrixSubBlock_SA(pb_param, TS, areaS, TF, vnF, hk, dt, gha, ghw);
