function matrixSubBlock = BEMenerg_calcMatrixSubBlock_DQM(indS, indF, pb_param, domainMesh, hk, dt, gha, ghw, dgn, dgw)
%INPUT
% - 
% -
%
...
for indGHS = 1 : nghS
    ...
    for var = 1 : 3
        ...
        if(ist_temp(var) > 0)
            ...
            tmp_js = BEMenerg_calcIntgInt_DG1D(pb_param, nodoGHScurr, TF, areaF, curr_t, dgn, dgw);
