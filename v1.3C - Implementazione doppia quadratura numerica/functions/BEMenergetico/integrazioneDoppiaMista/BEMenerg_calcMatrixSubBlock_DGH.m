function matrixSubBlock = BEMenerg_calcMatrixSubBlock_DGH(indS, indF, pb_param, domainMesh, hk, dt, gha, ghw)
%INPUT
% - 
% -
%
...
for indGHS = 1 : nghS
    ...
    for var = 1 : 3
        ...
        if(ist_temp(var) > 0)
            ...
            tmp_js = BEMenerg_calcIntgInt_GH(pb_param, nodoGHScurr, TF, areaF, curr_t, gha, ghw);
